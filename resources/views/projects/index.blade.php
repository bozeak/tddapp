...
@section('content')
    <header class="flex items-center mb-3 py-4">
        <div class="flex justify-between w-full items-end">
            <h2 class="text-gray font-normal">My projects</h2>
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" class="border border-muted-light p-2 px-2 text-xs block w-full rounded">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-sm block mb-2">Description</label>
                    <textarea id="description" name="description" class="border border-muted-light p-2 px-2 text-xs block w-full rounded" rows="7"></textarea>
                </div>
            </div>
